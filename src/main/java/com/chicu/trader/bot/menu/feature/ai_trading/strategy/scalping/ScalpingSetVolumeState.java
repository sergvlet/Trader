...
@Component("scalping_set_volume")
@RequiredArgsConstructor
public class ScalpingSetVolumeState implements MenuState {
    ...
    public SendMessage render(Long chatId) {
        ...
        return SendMessage.builder()
            ...
            .text(String.format("*Min volume:* `%.2f`", v))
            .parseMode("Markdown")
            .replyMarkup(kb)
            .build();
    }
