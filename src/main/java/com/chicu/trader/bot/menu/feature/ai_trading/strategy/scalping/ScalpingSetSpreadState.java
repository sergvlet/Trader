...
@Component("scalping_set_spread")
@RequiredArgsConstructor
public class ScalpingSetSpreadState implements MenuState {
    ...
    public SendMessage render(Long chatId) {
        ...
        return SendMessage.builder()
            ...
            .text(String.format("*Spread threshold:* `%.2f%%`", v))
            .parseMode("Markdown")
            .replyMarkup(kb)
            .build();
    }
