...
@Component("scalping_set_sl")
@RequiredArgsConstructor
public class ScalpingSetSlState implements MenuState {
    ...
    public SendMessage render(Long chatId) {
        ...
        return SendMessage.builder()
            ...
            .text(String.format("*Stop loss:* `%.2f%%`", v))
            .parseMode("Markdown")
            .replyMarkup(kb)
            .build();
    }
